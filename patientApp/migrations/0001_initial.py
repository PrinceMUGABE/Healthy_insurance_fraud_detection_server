    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient_code', models.CharField(max_length=50, unique=True, validators=[django.core.validators.RegexValidator(message='Enter a valid patient code. This value may contain only letters, numbers, and ./- characters.', regex='^[\\w.-]+$')])),
